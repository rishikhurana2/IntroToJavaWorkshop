...
System.out.println(mouseColor);
 ...
 int background = -1;
	...
	if(mouseColor==(background)){
		JOptionPane.showMessageDialog(null, "You Have Failed The Scary Maze, BE SCARED!");
		try {
			new Robot().mouseMove(180,320);
		...
		//10. if the mouse is on the end color
			int end = -16383746;
			if(mouseColor==(end)){
			JOptionPane.showMessageDialog(null,"You Beat The Scary Maze!");
